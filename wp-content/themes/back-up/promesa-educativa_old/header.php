...
<html lang="es">
	...
	<body>
		...
		<nav class="navbar navbar-default <?php if(isset($navbar_style)) { echo $navbar_style; } else { echo 'navbar-green'; } ?> <?php if(is_admin_bar_showing()) { echo 'admin-bar'; } ?>" id="navbar">
