...
<div class="wrapper quienes">
    ...
    <div class="presentacion spacing no-spacing-top">
        <div class="container text-center">
            <h1 class="header green">DOWNLOAD OUR</h1>
            <a href="<?php echo bloginfo('template_url'); ?>/pdf/presentacion_corporativa.pdf" class="white green-btn center-block" target="_blank">CORPORATIVE PRESENTATION</a>
        </div>
    </div>
    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    ...
    <div class="directivo light-spacing">
        ...
        <div class="container text-center">
            ...
            <div class="col-sm-6 no-padding">
                <h1 class="header green">BOARD OF DIRECTORS</h1>
                <table class="text">
                    <tbody>
    ...
    <div class="operativo">
        <div class="container">
            <h1 class="header green text-center">OPERATIVE TEAM</h1>
            <table class="text">
                <tbody>
                    <?php 
